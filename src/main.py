...
llm = ChatOllama(model="llama3:8b", base_url="http://server.raonworks.com:11434", temperature=1)
# llm = ChatOllama(model="qwen3:8b", base_url="http://server.raonworks.com:11434", temperature=1)
...
llm_answer = chain.invoke({"query": "자기장에 대해서 설명해줘"})
